...
async def handle_start(bot:Client, message:Message):
    ...
    Btn = [
        ...
        [InlineKeyboardButton(text='📰𝖴𝖯𝖣𝖠𝖳𝖤🗞️', url='https://t.me/thakur_bolte_haiiii'), InlineKeyboardButton(text='🤖𝖡𝖮𝖳 𝖨𝖭𝖥𝖮ℹ️', callback_data='about')],
        [InlineKeyboardButton(text='RISHANT', url='t.me/Oy_baby')]
        ]
